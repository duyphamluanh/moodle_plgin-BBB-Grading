...
function bigbluebuttonbn_supports($feature) {
    ...
    $features = [
        ...
        FEATURE_GRADE_HAS_GRADE => true, // ELO 
...
function bigbluebuttonbn_add_instance($bigbluebuttonbn) {
    ...
    bigbluebuttonbn_update_grades($bigbluebuttonbn);
 ...
 *
 * @category grade
 * @param object $quiz the bigbluebutton settings.
...
/**
 * Create or update the grade item for given bigbluebutton
 *
 * @category grade
 * @param object $bigbluebuttonbn object with extra cmidnumber
...
function bigbluebuttonbn_grade_item_update($bigbluebuttonbn, $grades = null) {
    ...
    $params = array('itemname'=>$bigbluebuttonbn->name, 'idnumber'=>$bigbluebuttonbn->cmidnumber);

    if ($bigbluebuttonbn->grade > 0) {
        $params['gradetype'] = GRADE_TYPE_VALUE;
        $params['grademax']  = $bigbluebuttonbn->grade;
        $params['grademin']  = 0;
    } else if ($bigbluebuttonbn->scale < 0) {
...
/**
 * Delete grade item for given bigbluebutton
 *
 * @category grade
 * @param object $bigbluebutton object
 * @return object bigbluebutton
 */
function bigbluebuttonbn_grade_item_delete($bigbluebuttonbn) {
    global $CFG;
    require_once($CFG->libdir . '/gradelib.php');

    return grade_update('mod/bigbluebuttonbn', $bigbluebuttonbn->course, 'mod', 'bigbluebuttonbn', $bigbluebuttonbn->id, 0,
...
function bigbluebuttonbn_reset_gradebook($courseid, $type='') {
    ...
    $bigbluebuttonbns = $DB->get_records_sql("
            SELECT q.*, cm.idnumber as cmidnumber, q.course as courseid
            FROM {modules} m
            JOIN {course_modules} cm ON m.id = cm.module
            JOIN {bigbluebuttonbn} q ON cm.instance = q.id
            WHERE m.name = 'bigbluebutton' AND cm.course = ?", array($courseid));
 ...
 * @param mixed $userid optional user id, 0 means all users
 * @return array array of grades, false if none
 */
function bigbluebuttonbn_get_user_grades($bigbluebuttonbn, $userid = null) {
    global $CFG, $DB;
    require_once($CFG->libdir . '/gradelib.php');
    require_once($CFG->dirroot . '/rating/lib.php');

    $ratingoptions = new stdClass;
    $ratingoptions->component = 'mod_bigbluebuttonbn';
    $ratingoptions->ratingarea = 'bigbluebuttonbn';
    $ratingoptions->modulename = 'data';
    $ratingoptions->moduleid   = $bigbluebuttonbn->id;
    $ratingoptions->userid = $userid;
    $ratingoptions->scaleid = $bigbluebuttonbn->scale;
    $ratingoptions->itemtable = 'bigbluebuttonbn_grades';
