 ...
 */
class meeting_started extends base {
    /**
     * Init method.
     * @param string $crud
     * @param int $edulevel
    ...
    protected function init($crud = 'r', $edulevel = self::LEVEL_OTHER) {
        ...
        $this->description = "The user with id '##userid' started a bigbluebutton meeting for ".
    ...
    public static function get_name() {
        return get_string('event_meeting_started', 'bigbluebuttonbn');
    }
