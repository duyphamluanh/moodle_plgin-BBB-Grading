...
export const eventTypes = {
     ...
     * @property {object} detail
     */
     currentSessionGrading: 'mod_bigbluebuttonbn/currentSessionGrading',
};
...
/**
 * Trigger the notifySessionCanGrading event.
 *
 * @param {number} bbbId
 * @param {number} groupId
 * @returns {CustomEvent}
 * @fires event:mod_bigbluebuttonbn/currentSessionGrading
 */
export const notifySessionCanGrading = (bbbId, groupId) => dispatchEvent(eventTypes.currentSessionGrading, {
    bbbId,
    groupId,
});
