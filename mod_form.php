...
class mod_bigbluebuttonbn_mod_form extends moodleform_mod {
    ...
    public function definition(): void {
        ...
        // $this->add_bigbluebuttonbn_grade_settings($mform, 'bigbluebuttonbn');
    ...
    private function add_bigbluebuttonbn_grade_settings($mform, string $itemname) {
        global $COURSE;
        ...
        $mform->addElement('modgrade',$gradefieldname,get_string("{$gradefieldname}_title", $component),$gradeoptions);
