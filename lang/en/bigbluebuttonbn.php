...
// Elo
$string['event_meeting_started'] = 'Activity started';
$string['view_conference_action_grading'] = 'Grade this session';
$string['grading_session_confirm_title'] = 'Grading this session?';
$string['grading_session_confirm'] = 'Are you sure you want to grade the session?';
$string['grading_session_in_table'] = 'You can grade this session in the grading table below.';
$string['grading_title_recordings'] = 'Grading table';
$string['view_message_nousers'] = 'No users enroll';
$string['grade_bigbluebuttonbn_header'] = 'Grading';
$string['grade_title'] = 'Grade';
